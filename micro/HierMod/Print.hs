...
instance Print HierMod.Abs.Decl where
  prt i e = case e of
    ...
    HierMod.Abs.Ref qname -> prPrec i 0 (concatD [doc (showString "module"), doc (showString "_"), doc (showString "="), prt 0 qname])

instance Print HierMod.Abs.Decls where
  prt i e = case e of
    HierMod.Abs.DNil -> prPrec i 0 (concatD [])
    HierMod.Abs.DSnoc decls decl -> prPrec i 0 (concatD [prt 0 decls, prt 0 decl])
