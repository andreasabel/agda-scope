...
\newcommand{\dentt}[1]{\llparenthesis#1\rrparenthesis}
...
\newcommand{\talias}{\mathsf{alias}}
\newcommand{\topen}{\mathsf{open}}

\newcommand{\mdef}[2]{\tmodule\;#1\;#2}
\newcommand{\mdefp}[2]{\tmodule\;#1\;(#2)}
\newcommand{\mref}[1]{\tref\;#1}
\newcommand{\malias}[2]{\talias\;#1\;#2}
\newcommand{\mopen}[1]{\topen\;#1}
\newcommand{\mopenr}[2]{\topen\;#1\;#2}

\newcommand{\sep}{\cdot}%{\,.\,}%\mathbin{.}}
\newcommand{\chop}{\cdot}
\newcommand{\defined}{\mathop{\mathsf{def}}}

\newcommand{\Contains}[2]{#1\ni#2}
\newcommand{\NotContains}[2]{#1\notni#2}
\newcommand{\Declares}[2]{#1\der#2}
\newcommand{\NotDeclares}[2]{#1\not\der#2}
\newcommand{\rthere}{\rulename{there}}
\newcommand{\rhere}{\rulename{here}}
\newcommand{\rinto}{\rulename{into}}
\newcommand{\rparent}{\rulename{parent}}
\newcommand{\rfollow}{\rulename{follow}}
\newcommand{\ropen}{\rulename{open}}

\newcommand{\NoClash}[2]{#1 \perp #2}
\newcommand{\WContent}[2]{#1\der#2}
\newcommand{\WScope}[1]{\der#1}
...
\newcommand{\bnum}{\mathsf{bnum}}
\newcommand{\RE}{\mathsf{RE}}
\newcommand{\sfe}{\mathsf{e}}
\newcommand{\AgdaDatatype}[1]{\mathsf{#1}}
\newcommand{\AgdaFunction}[1]{\mathsf{#1}}
\newcommand{\lsub}[1]{\delta_{#1}}
\newcommand{\liftpw}[1]{\tilde{#1}}

% derivation
\newcommand{\lder}[2]{\delta_{#2}\,#1}    % or #1/#2
\newcommand{\lderq}[2]{\delta_{#2}\,#1}   % or #1/(#2)
\newcommand{\lderp}[2]{\delta_{#2}(#1)} % or (#1)/#2
\newcommand{\derdots}[1]{\dots#1}
% \newcommand{\lder}[2]{#1/#2}
% \newcommand{\lderq}[2]{#1/(#2)}
% \newcommand{\lderp}[2]{#1/#2}
% \newcommand{\derdots}[1]{#1/\dots}
